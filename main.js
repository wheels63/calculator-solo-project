...
function minus() {
  operator = "-"
  document.querySelector("#placeToShowOperator").innerText = "-";
...
function multiplication() {
  operator = "x";
  document.querySelector("#placeToShowOperator").innerText = "x";
}
...
function reset() {
  operator = "";
  total = 0;
  document.querySelector("#placeToShow").innerText = "The calculator is reset";
}
